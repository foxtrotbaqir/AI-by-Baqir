# -*- coding: utf-8 -*-
"""Random Forest Model for IOT.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1E7q8dPSbMQmfMVwLxbNWplMgTUUjeo3i
"""
...
def plot_Error_matrix(cm, classes,
    ...
    plt.savefig('Error Matrix for Random Forest Model.png')

cf_matrix = Error_matrix(y_test, y_pred_rf)
...
plot_Error_matrix(cf_matrix, classes=['Normal', 'Backdoor Attack', 'injection Attack', 'password Attack', 'ddos Attack', 'ransomware Attack', 'xss Attack', 'scanning Attack'],
                      normalize = True, title='Error Matrix With Normalization - Random Forest Model')
plt.show()